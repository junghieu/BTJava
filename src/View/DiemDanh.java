...
public class DiemDanh extends JFrame {
	...
	public DiemDanh() {
		...
		txtimDanh = new JTextField();
		txtimDanh.setText("Điểm danh");
		txtimDanh.setHorizontalAlignment(SwingConstants.CENTER);
		txtimDanh.setFont(new Font("Tahoma", Font.BOLD, 20));
		txtimDanh.setColumns(10);
		txtimDanh.setBounds(0, 0, 211, 47);
		panel_1.add(txtimDanh);
		
		// Form điểm danh
		JPanel formPanel = new JPanel();
		formPanel.setLayout(null);
		formPanel.setBounds(359, 100, 866, 500); // Điều chỉnh vị trí và kích thước
		formPanel.setBackground(Color.WHITE);
		contentPane.add(formPanel);

		// Label & TextField - Tên hội viên
		JLabel lblTenHoiVien = new JLabel("Tên hội viên:");
		lblTenHoiVien.setBounds(30, 30, 100, 25);
		formPanel.add(lblTenHoiVien);

		JTextField txtTenHoiVien = new JTextField();
		txtTenHoiVien.setBounds(150, 30, 200, 25);
		formPanel.add(txtTenHoiVien);

		// Label & DateChooser - Ngày điểm danh
		JLabel lblNgay = new JLabel("Ngày:");
		lblNgay.setBounds(30, 70, 100, 25);
		formPanel.add(lblNgay);


		// Label & TextField - Giờ check-in
		JLabel lblCheckIn = new JLabel("Giờ Check-in:");
		lblCheckIn.setBounds(30, 110, 100, 25);
		formPanel.add(lblCheckIn);

		JTextField txtCheckIn = new JTextField();
		txtCheckIn.setBounds(150, 110, 200, 25);
		formPanel.add(txtCheckIn);

		// Label & TextField - Giờ check-out
		JLabel lblCheckOut = new JLabel("Giờ Check-out:");
		lblCheckOut.setBounds(30, 150, 100, 25);
		formPanel.add(lblCheckOut);

		JTextField txtCheckOut = new JTextField();
		txtCheckOut.setBounds(150, 150, 200, 25);
		formPanel.add(txtCheckOut);

		// Label & TextArea - Ghi chú
		JLabel lblGhiChu = new JLabel("Ghi chú:");
		lblGhiChu.setBounds(30, 190, 100, 25);
		formPanel.add(lblGhiChu);

		JTextArea txtGhiChu = new JTextArea();
		txtGhiChu.setBounds(150, 190, 300, 100);
		formPanel.add(txtGhiChu);

		// Button - Lưu
		JButton btnLuu = new JButton("Lưu");
		btnLuu.setBounds(150, 310, 100, 30);
		formPanel.add(btnLuu);

		// Button - Hủy
		JButton btnHuy = new JButton("Hủy");
		btnHuy.setBounds(270, 310, 100, 30);
